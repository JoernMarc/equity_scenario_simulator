...
export const translations = {
  en: {
    appTitle: "Equity Scenario Planner",
    milestone: "Milestone 1: Data Entry",
    ...
    shareCapitalRequirementWarning: "Note: The total investment is less than the typical required share capital of {amount}.",
    ...
    fixedConversionPrice: "Fixed Conversion Price (€ / Share)",
    ratioShares: "Shares",
    ...
    help: {
      ...
      fixedRatio: "The loan converts based on a defined ratio. For example, '1 Share for Amount 1000' means the investor receives one share for every €1,000 of principal and interest owed.",
...
`,
      disclaimerTitle: "Disclaimer & Feedback",
...
I am grateful for any feedback or suggestions for improvement. Please send them to: kontakt@jodecon.de`,
  ...
  de: {
    appTitle: "Equity Scenario Planner",
    milestone: "Meilenstein 1: Dateneingabe",
    ...
    shareCapitalRequirementWarning: "Hinweis: Die Gesamtinvestition unterschreitet das übliche Stammkapital von {amount}.",
    ...
    fixedConversionPrice: "Fester Wandlungspreis (€ / Anteil)",
    ratioShares: "Anteile",
    ...
    help: {
      ...
      fixedRatio: "Das Darlehen wird auf der Grundlage eines festgelegten Verhältnisses umgewandelt. Zum Beispiel bedeutet '1 Anteil für Betrag 1000', dass der Investor für jede 1.000 € geschuldeter Hauptsumme und Zinsen einen Anteil erhält.",
    ...
    legal: {
      ...
      tabDisclaimer: "Haftungsausschluss",
...
`,
      disclaimerTitle: "Haftungsausschluss & Feedback",

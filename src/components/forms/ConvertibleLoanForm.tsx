...
function ConvertibleLoanForm({ onSubmit, onCancel, translations, transactionToEdit, stakeholders }: ConvertibleLoanFormProps) {
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <CurrencyInput value={amount} onChange={setAmount} required id="amount" />
        </div>
        <div>
      ...
      {conversionMechanism === ConversionMechanism.CAP_AND_DISCOUNT && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 bg-theme-subtle rounded-md border border-theme-subtle">
            <div>
              ...
              <CurrencyInput value={valuationCap} onChange={setValuationCap} id="valuationCap" />
            </div>
            <div>
      ...
      {conversionMechanism === ConversionMechanism.FIXED_PRICE && (
        <div className="p-4 bg-theme-subtle rounded-md border border-theme-subtle">
            <label htmlFor="fixedConversionPrice" className="flex items-center text-sm font-medium text-theme-secondary">
                {t.fixedConversionPrice}
                <HelpTooltip text={t.help.fixedPrice} />
            </label>
            <CurrencyInput value={fixedConversionPrice} onChange={setFixedConversionPrice} id="fixedConversionPrice" required />
        </div>
      )}
      ...
      {conversionMechanism === ConversionMechanism.FIXED_RATIO && (
        <div className="p-4 bg-theme-subtle rounded-md border border-theme-subtle">
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                    <label htmlFor="ratioAmount" className="text-xs text-theme-secondary">{t.forAmount}</label>
                    <CurrencyInput value={ratioAmount} onChange={setRatioAmount} id="ratioAmount" required />
                </div>
            </div>
        </div>
      )}

...
import type { Transaction, FoundingTransaction, ConvertibleLoanTransaction, FinancingRoundTransaction, ShareTransferTransaction, Language, ShareClass, DebtInstrumentTransaction, UpdateShareClassTransaction, Stakeholder } from '../types';
